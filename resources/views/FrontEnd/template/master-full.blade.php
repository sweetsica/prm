...
<div class="hk-wrapper hk-vertical-nav">
    ...
    <nav class="navbar navbar-expand-xl navbar-light fixed-top hk-navbar">
        <a class="navbar-brand" href="{{asset("/")}}">
            <img class="brand-img d-inline-block" src="{{asset('src/dist/img/logo-light.png')}}" alt="brand" />
        </a>
...
{{--                                        <img src="{{asset('src/dist/img/avatar1.jpg')}}" alt="user" class="avatar-img rounded-circle">--}}
{{--                                    </div>--}}
{{--                                </div>--}}
...
{{--                                <div class="media-img-wrap">--}}
{{--                                    <div class="avatar avatar-sm">--}}
{{--                                        <img src="{{asset('src/dist/img/avatar2.jpg')}}"" alt="user" class="avatar-img rounded-circle">--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                                <div class="media-body">--}}
{{--                                    <div>--}}
...
{{--                        </div>--}}
                        <div class="media-body">
                            <span>{{Session::get('customer_name')}}<i class="zmdi zmdi-chevron-down"></i></span>
                        </div>
                    </div>
                </a>
...
{{--    <!-- /Vertical Nav -->--}}
    ...
    <div class="hk-settings-panel">
        <div class="nicescroll-bar position-relative">
            <div class="settings-panel-wrap">
                <div class="settings-panel-head">
                    <img class="brand-img d-inline-block align-top" src="{{asset('src/dist/img/logo-light.png')}}" alt="brand" />
                ...
                <div class="layout-img-wrap">
                    <div class="row">
                        <a href="javascript:void(0);" class="col-6 mb-30 active">
                            <img class="rounded opacity-70" src="{{asset('src/dist/img/layout1.png')}}" alt="layout">
                            <i class="zmdi zmdi-check"></i>
                        </a>
                        <a href="dashboard2.html" class="col-6 mb-30">
                            <img class="rounded opacity-70" src="{{asset('src/dist/img/layout2.png')}}" alt="layout">
                            <i class="zmdi zmdi-check"></i>
                        </a>
                        <a href="dashboard3.html" class="col-6 mb-30">
                            <img class="rounded opacity-70" src="{{asset('src/dist/img/layout3.png')}}" alt="layout">
                            <i class="zmdi zmdi-check"></i>
                        </a>
                        <a href="dashboard4.html" class="col-6 mb-30">
                            <img class="rounded opacity-70" src="{{asset('src/dist/img/layout4.png')}}" alt="layout">
                            <i class="zmdi zmdi-check"></i>
                        </a>
                        <a href="dashboard5.html" class="col-6">
                            <img class="rounded opacity-70" src="{{asset('src/dist/img/layout5.png')}}" alt="layout">
                            <i class="zmdi zmdi-check"></i>
                        </a>
                    </div>
                </div>
        ...
        <img class="d-none" src="{{asset('src/dist/img/logo-light.png')}}" alt="brand" />
        <img class="d-none" src="{{asset('src/dist/img/logo-dark.png')}}" alt="brand" />
    </div>
    <!-- /Setting Panel -->
